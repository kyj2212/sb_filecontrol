...
public class TestInitData {
    ...
    CommandLineRunner init(MemberService memberService, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            try {
                memberService.create("user1", password, "유저1","user1@test.com");
                memberService.create("user2", password, "유저2","user2@test.com");
                memberService.create("user3", password, "유저3","user3@test.com");
                memberService.create("user4", password, "유저4","user4@test.com");
